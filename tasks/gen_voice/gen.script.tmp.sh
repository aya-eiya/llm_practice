...
jq -n "[{\"System\": \"Now, let's move on to the conversation between Billy, Meg, Kelly, and their teacher, Louis, after reading the novel.\"}]" > /tmp/gen_voice_pre_dialog.json
