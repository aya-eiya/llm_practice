...
const PRs: PR[] = [
  {
    ...
    image: images?.["A8N001"] || "", // JSONから安全に取得
  },
  {
    id: "A8N002",
    provider: "A8",
    ...
    image: images?.["A8N002"] || "", // JSONから安全に取得
  },
  {
    id: "AMZ001",
    provider: "Amazon",
    ...
    image: images?.["AMZ001"] || "", // JSONから安全に取得
  },
  {
    id: "AMZ002",
    provider: "Amazon",
    ...
    image: images?.["AMZ002"] || "", // JSONから安全に取得
  },
  {
    id: "AMZ003",
    provider: "Amazon",
    ...
    image: images?.["AMZ003"] || undefined, // JSONから安全に取得 (undefined許容)
  },
];
export default PRs;
