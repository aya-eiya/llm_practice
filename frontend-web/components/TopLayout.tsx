            ...
            <section id="usage" className="mb-16">
              <header className="text-center mb-4">
                ...
                <p className="mt-2 text-xl">
                  Daily AI-generated English novels and learning-focused test
                  questions to improve English proficiency.
                </p>
              </header>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="md:col-span-1 p-4 bg-slate-50">
                  ...
                  <p className="text-lg">
                    After reading the passage, answer the questions provided.
                    The questions test your comprehension and critical thinking
                    skills, helping you engage with the text.
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="md:col-span-2">
                  ...
                  <ul className="mx-4">
                    ...
                    <li className="mt-2">
                      ...
                      to automatically receive new listening audio as it becomes
                      available.
                    </li>
                  </ul>
                </div>
                <div className="md:col-span-1 p-4 bg-white">
                  ...
                  <p className="text-lg">
                    Start by listening to the passage read by the narrator. The
                    narrator's soothing voice guides you through the story,
                ...
                <div className="md:col-span-1 p-4 bg-white">
                  ...
                  <p className="text-lg">
                    ...
                    provided. The questions test your comprehension and critical
                    thinking skills, helping you engage with the text.
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
