...
const data: QuizData = {
  "event": {
    "event": "The Death of Alexander the Great",
    "details":
      "Alexander the Great, king of the ancient Greek kingdom of Macedon, died on July 15th in Babylon, present-day Baghdad, Iraq.",
  },
  "date": "2025-07-15",
  "title": "Beyond the Euphrates",
  "body":
  ...
  "quiz": [
    {
      "question": "Where did Alexander meet Meg for the first time?",
      "options": [
        "Babylon",
        "Egypt",
        "Greece",
        "India",
        "The court of Ptolemy in Egypt",
      ],
      "answer": 3,
    },
    {
      ...
      "options": [
        "Disease caused by snake bite",
        "Fever",
        "Wounded leg",
        "Fatigue and pain due to overwork",
        "Hungry stomach",
      ],
      "answer": 1,
    },
    {
      "question": "What did Billy love about the story?",
      "options": [
        "The way Alexander's character development was portrayed",
        "The descriptive language used by the author",
        "The dialogue among characters",
        "The setting of Babylon",
        "All of the above",
      ],
      "answer": 1,
    },
    {
      "question": "Who was the historian mentioned in the dialogue?",
      "options": [
        "Billy",
        "Kerry",
        "Meg",
    ...
    {
      "question": "What made Kerry feel sad while reading the story?",
      "options": [
        "Alexander's victory over his enemies",
        "The division of Alexander's kingdom among his generals",
        "The way Meg was treated unfairly by Alexander",
        "The emotional depth of the story",
        "Alexander's fever not breaking",
      ],
      "answer": 3,
    },
  ],
