...
const data: QuizData = {
  "event": {
    "event": "Opening of the Centre Georges Pompidou, Paris",
    "details":
      "The Centre Georges Pompidou, also known as the Beaubourg, was opened to the public on May 30, 1977, in Paris, France. Designed by architects Renzo Piano and Richard Rogers, it marked a radical departure from traditional museum architecture with its colorful tubular steel exterior and indoor gardens.",
  },
  "date": "2025-05-30",
  "title": "Beyond the Beaubourg",
  "body":
  ...
  "dialog": [
    {
      "Meg": "I just finished reading the novel, it's so magical!",
    },
    {
      "Lui":
  ...
  "quiz": [
    {
      ...
      "options": [
        "A museum",
        "A library",
        "A place where art and magic collided",
        "A school",
        "A restaurant",
      ],
      "answer": 2,
    },
    {
      ...
      "options": [
        "As a simple building with no special features",
        "As a maze of colorful tubular steel",
        "As a building made of glass and stone",
        "As a small courtyard",
        "As a large park",
      ],
      "answer": 1,
    },
    {
      "question": "What happened to the Centre Georges Pompidou at night?",
      "options": [
        "It became darker",
        "It transformed into twinkling lights",
    ...
    },
    {
      ...
      "options": [
        ...
        "That it was only for people who love science fiction",
        "That it was a place where imagination came alive",
        "That it was a real-life fantasy world",
        "That it was not special at all",
      ],
      "answer": 2,
    },
  ],
