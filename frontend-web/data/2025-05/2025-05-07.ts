...
const data: QuizData = {
  ...
  "dialog": [
    ...
    {
      "Kerry": "But what really caught my attention was the mysterious figure lurking in the shadows! It sounded like some kind of supernatural entity."
    },
    {
      "Billy": "I agree with Kerry, that part was so intriguing! I love how it kept you guessing about what was real and what wasn't."
    },
    {
      "Meg": "And the May Queen's courtiers were such an interesting detail. I loved how they added to the mystique of the evening."
    },
    {
      "Lui": "Indeed, the author did a great job of weaving together all these different elements to create this enchanting world."
    },
    {
      "Kerry": "I'm still thinking about what that mysterious figure might have been... A ghost? A shapeshifter?"
    },
    {
      "Billy": "Maybe it was something entirely unexpected! I love how stories like this can keep you guessing and thinking long after you finish reading."
    }
  ],
  "quiz": [
    {
    ...
    {
      "question": "What began to circulate about a mysterious figure lurking in the shadows?",
      "options": [
        "Whispers of a ghost",
