...
const data: QuizData = {
  ...
  "body": "The once blue skies were now a permanent grey, casting a desolate shadow over the ruins of humanity. I trudged through the dusty wasteland, my footsteps echoing off the crumbling buildings. The world had ended in a catastrophic event known as 'The Day of the Jackal', where a deadly virus had ravaged the planet, leaving only a few scattered survivors.  \n\n As I walked, I stumbled upon a makeshift settlement, consisting of rickety shelters and makeshift tents. People huddled together, their faces etched with worry and fear. The air was thick with desperation, as they struggled to find food, water, and shelter in this desolate new world.  \n\n I approached one of the residents, a grizzled old man named Marcus, who eyed me warily. 'What brings you here?' he growled. I explained my situation, and he nodded thoughtfully. 'You're lucky to have made it this far,' he said. 'But be warned, the world is full of dangers, both human and otherwise.'",
  "word count": 159,
  "dialog": [
    {
      "Meg": "I loved how the author described the world after the apocalypse! It was so vivid in my mind."
    },
    {
      "Lui": "Indeed, the author's use of language is quite impressive. I particularly liked how they portrayed the desperation and fear in the settlement."
    },
    {
      "Kerry": "I know what you mean, Meg! And I loved how Marcus, the old man, was like a mentor to the protagonist. It felt so real!"
    },
    {
      "Billy": "Yeah, and I think it's interesting how the author made me feel like I was there with the protagonist in that wasteland."
    },
    {
      "Meg": "Exactly! And I loved how the novel explored themes of survival and humanity in the face of catastrophic failure."
    },
    {
      "Lui": "The author did a great job of balancing action, suspense, and emotional depth. It's not an easy feat to pull off!"
    },
    {
      "Kerry": "I'm still trying to process everything that happened in the novel. There were so many twists and turns!"
    },
    {
      "Billy": "Me too! I'm planning on re-reading it soon just to see if I caught all the clues this time around."
    }
  ],
  "quiz": [
    {
