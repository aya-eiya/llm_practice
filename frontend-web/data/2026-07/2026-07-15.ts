...
const data: QuizData = {
  ...
  "body":
    "In the realm of Aethoria, where stars danced across the sky and magic was woven into the very fabric of existence, the grand opening of the Celestial Expo had finally arrived. The fair, a marvel of engineering and wonder, showcased the latest innovations in stardust harvesting and celestial cartography.  \n\nAs guests entered the expo, they were greeted by the majestic sight of a life-size model of the Cosmic Chariot, a vessel rumored to be capable of traversing the vast expanse between galaxies. The Chariot's sleek design and advanced propulsion system had sparked heated debates among the scientific community, with some hailing it as a revolutionary breakthrough and others dismissing it as mere fantasy.  \n\nAmong the expo's many attractions was the esteemed Professor Orion's lecture on 'Unlocking the Secrets of Stellar Energy.' With his characteristic charm and wit, the professor regaled the audience with tales of ancient civilizations that had harnessed the power of stardust to build sprawling cities and harness the very fabric of reality. Though some attendees remained skeptical, many were inspired by the prospect of unlocking the secrets of the cosmos.",
  "word count": 183,
  "dialog": [
    {
      "Meg":
        "I just finished reading the novel, and I have to say it's one of my favorites! The world-building is incredible.",
    },
    {
      "Kerry":
        "I know what you mean, Meg! I loved how they described the Celestial Expo. It sounds like a real-life fantasy come true.",
    },
    {
      "Lui":
        "As an educator, I appreciate how the novel weaves in complex scientific concepts and makes them accessible to readers of all ages.",
    },
    {
      "Billy":
        "I'm more interested in the life-size model of the Cosmic Chariot! Do you think it's really possible to build something like that?",
    },
    {
      "Meg":
        "I agree with Billy, I want to know more about how they came up with such an advanced propulsion system. It's amazing what humans can create when they work together.",
    },
    {
      "Lui":
        "Indeed, the novel highlights the importance of collaboration and innovation in pushing human knowledge forward. But let's not forget the themes of responsibility that are woven throughout the story.",
    },
    {
      "Kerry":
        "Responsibility? I thought it was more about exploring the unknown and pushing boundaries!",
    },
    {
      "Billy":
        "I think Kerry has a point, Lui. The novel does make us wonder what lies beyond our galaxy, and whether we'll ever be able to reach it.",
    },
    {
      "Meg":
        "But that's the beauty of it - the novel leaves us with so many questions and possibilities, making us feel like we're part of this grand adventure too.",
    },
  ],
  "quiz": [
    {
