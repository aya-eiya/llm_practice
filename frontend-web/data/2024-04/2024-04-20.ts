...
const data: QuizData = {
  "event": {
    "event": "First public screening of Charlie Chaplin's 'The Gold Rush'",
    "details":
      "On April 20th, 1925, Charlie Chaplin premiered his silent film 'The Gold Rush' at the Strand Theatre in New York City, marking a significant milestone in the history of cinema.",
  },
  "date": "2024-04-20",
  "title": "Charlie Chaplin and The Gold Rush",
  "body":
  ...
  "quiz": [
    ...
    },
    {
      ...
      "options": [
        "Chaplin's character trying to eat his own shoe",
        "A group of dogs playing together",
        "Chaplin's character finding gold",
        "Chaplin's character getting married",
        "Chaplin's character going on a picnic",
      ],
      "answer": 0,
    },
    {
