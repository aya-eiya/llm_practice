...
const data: QuizData = {
  "event": {
    "event": "Debut of 'The Gold Rush' by Charlie Chaplin",
    "details":
      "April 19th, 1925 - The silent film comedy 'The Gold Rush' starring Charlie Chaplin was released on this day and became a huge success.",
  },
  "date": "2024-04-19",
  "title": "The Curse of Gold Mountain",
  "body":
  ...
  "quiz": [
    {
      "question": "What was Charlie Chaplin's role in the story?",
      "options": [
        "A famous scientist",
    ...
    },
    {
      ...
      "options": [
        ...
        "It added an extra layer of depth to the story",
        "It was irrelevant to the plot",
        "It made the story boring",
        "It didn't blend anything",
      ],
      "answer": 1,
    },
    {
    ...
    {
      "question": "What was added to the story by Chaplin's character?",
      "options": [
