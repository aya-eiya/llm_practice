...
const data: QuizData = {
  "event": {
    "event": "Death of Antoni Gaudí",
    "details":
      "Spanish architect Antoni Gaudí was struck by a tram on December 4, 1925, at age 73 while walking in Barcelona. He died shortly after from his injuries.",
  },
  "date": "2025-12-04",
  "title": "The Architect of Eternity",
  "body":
  ...
  "quiz": [
    {
      "question": "What city does Gaudí's architectural work belong to?",
      "options": [
        "Barcelona",
        "Aetherion",
        "Sagrada Familia",
    ...
    {
      "question": "What is Meg's age and gender according to the text?",
      "options": [
        "11 years old, boy",
        "12 years old, girl",
        "13 years old, male",
        "14 years old, female",
        "15 years old, transgender",
      ],
      "answer": 1,
    },
    {
      "question": "Which historical figure is the main character of the story?",
      "options": [
        "Da Vinci",
        "Gaudí",
        "Le Corbusier",
    ...
    },
    {
      ...
      "options": [
        ...
        "Complex but difficult to understand",
