...
const data: QuizData = {
  "event": {
    "event": "The Great Fashion Disaster",
    "details":
      "December 26, 1893: The first public performance of Paul Poiret's 'Dance of the Thousand and One Nights' caused a fashion scandal when his avant-garde dress designs were deemed too revealing for Victorian standards. The event marked a turning point in haute couture history as it challenged traditional dress codes.",
  },
  "date": "2025-12-26",
  ...
  "quiz": [
    ...
    {
      "question": "How old is Billy according to the dialogue note?",
      "options": [
        "10 years old",
        "11 years old",
        "12 years old",
    ...
    },
    {
      ...
      "options": [
        "He wasn't influential at all",
        "He built upon Charles Worth's ideas",
        "He was more influential than expected",
    ...
    {
      "question": "According to Lui, what is the basis of the novel?",
      "options": [
        "It's entirely fictional",
        "It's based on historical events",
        "It's a modern adaptation",
        "It's inspired by real people but not true",
        "None of the above",
      ],
      "answer": 1,
    },
