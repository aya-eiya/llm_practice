...
const data: QuizData = {
  "event": {
    "event": "The First National Convention of Delegates for Women's Rights",
    "details":
      "On September 5, 1850, women from across the United States gathered in Worcester, Massachusetts to discuss issues such as property rights and divorce laws. This convention marked one of the first organized efforts by women to address their social and legal status in American society.",
  },
  "date": "2025-09-05",
  ...
  "quiz": [
    {
      "question": "Where did Margaret come from to attend this gathering?",
      "options": [
        "Boston",
        "New York City",
        "Philadelphia",
