...
const data: QuizData = {
  "event": {
    "event": "Terrorist Attacks on World Trade Center",
    "details":
      "On September 11, 2001, two commercial aircraft were hijacked by terrorists and intentionally crashed into the Twin Towers of the World Trade Center in New York City. The attacks killed nearly 3,000 people and led to a major shift in architectural design standards worldwide.",
  },
  "date": "2025-09-11",
  ...
  "quiz": [
    ...
    {
      "question": "What color was the sunset according to Kerry's comment?",
      "options": [
        "Blue",
        "Orange",
        "Red",
