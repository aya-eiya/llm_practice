...
const data: QuizData = {
  "event": {
    "event": "Opening of the Museum of Modern Art (MoMA) New Building",
    "details":
      "On September 12, 1939, the new building of The Museum of Modern Art (MoMA) was opened to the public in New York City, marking a significant moment in modern art history.",
  },
  "date": "2025-09-12",
  "title": "When Time Paints Museums",
  "body":
  ...
  "quiz": [
    {
      ...
      "options": [
        "In 1939",
        "On that September morning in 1939",
        "As a child with my parents",
        "When it opened its new wing",
        "I'm not sure",
      ],
      "answer": 1,
    },
    ...
    {
      "question": "What material are the museum walls described as made of?",
      "options": [
        "Brick",
        "White marble",
        "Wooden paneling",
