...
const data: QuizData = {
  "event": {
    ...
    "details":
      "Massive protests and demonstrations across China on May 4th, 1919, in response to Japan's victory over Germany and its subsequent annexation of Qingdao, which led to widespread nationalist sentiment, anti-Japanese sentiment, and the beginning of modern Chinese nationalism.",
  },
  "date": "2024-05-04",
  "title": "The Rise of the Red Dragon",
  "body":
    "In a world where dragons once ruled the skies and ancient magic flowed through the veins of all living things, a powerful movement was born on May 4th. A group of brave warriors, fueled by the desire for freedom and justice, rose up against their oppressors. They were known as the Red Dragons, a diverse coalition of humans and dragons alike, united in their quest to overthrow the tyrannical rule of the corrupt Emperor.Their movement began on May 4th, with a massive protest that swept through the cities and towns of the kingdom. The people were fed up with the Emperor's corruption and mistreatment of his subjects, and they were ready for change. As the protests grew in size and intensity, the Red Dragons emerged as leaders, guiding the movement towards victory.Their actions inspired others to join their cause, and soon a full-scale revolution was underway. The Red Dragons fought bravely, using ancient magic and powerful dragon breath to strike fear into the hearts of their enemies. Despite fierce resistance from the Emperor's armies, they emerged victorious, and a new era of peace and prosperity dawned upon the kingdom.",
  "word count": 189,
  "dialog": [
    {
      "Billy":
        "Wow, I loved how the Red Dragons used their unique skills to fight against the Emperor!",
    },
    {
      "Meg":
        "I know, right? The way they combined magic and dragon breath was so cool!",
    },
    {
      "Kerry":
        "Yeah, and it's amazing that they were able to inspire others to join their cause. The Emperor must have been really corrupt.",
    },
    {
      "Lui":
        "Well, as a history teacher, I can tell you that this kind of revolution is exactly what we need sometimes. A fresh start and a chance to rebuild.",
    },
    {
      "Billy":
        "I liked how the novel highlighted the importance of unity and cooperation. It's not always easy to work together, but in the end it leads to success.",
    },
    {
      "Meg":
        "Absolutely! And I loved how the dragons were treated as equals by the Red Dragons. It shows that even the most unlikely creatures can be friends.",
    },
    {
      "Kerry":
        "Yeah, and let's not forget about the Emperor's corruption! I'm glad they finally stood up against him.",
    },
    {
      "Lui":
        "Well, it's clear that this novel has sparked some great discussions among you all. Let's keep exploring these themes and ideas in our own ways.",
    },
  ],
  "quiz": [
    {
      ...
      "vocabularies": [
        {
          ...
          "pronounce": "/ˈdræɡənz/",
          "example":
            "The new fantasy novel features a dragon as the main protagonist.",
        },
        {
          "class": "Noun",
          "word": "Emperor",
        ...
        },
        {
          ...
          "word": "Freedom",
          "meaning":
            "The state of being free from slavery, captivity, or oppression.",
          "usage": [
        ...
        },
        {
          ...
          "word": "Magic",
          "meaning":
            "The art of producing a desired effect or illusion by using supernatural or mystical powers.",
          "usage": [
        ...
        },
        {
          ...
          "word": "Revolution",
          "meaning":
            "A sudden, complete change in the way things are done or thought about.",
          "usage": [
