...
const data: QuizData = {
  ...
  "body": "In a world where communication was limited to letters and telegrams, a brilliant inventor named Alexander Graham Bell had a vision for a device that could instantly connect people across vast distances. With his team of engineers and scientists, he worked tirelessly in his lab, day and night, to bring this dream to fruition. Finally, after years of dedication and hard work, the moment arrived when they were ready to demonstrate their invention to the world.On a crisp autumn morning, as the sun was just beginning to rise, Bell and his team set up their contraption in the center of a bustling city square. People from all walks of life had gathered around to witness this incredible feat of technology. As the crowd held their breath, waiting for the magic to happen, Bell picked up the receiver and spoke into it, his voice echoing through the airwaves.The device was called the telephone, and its invention would forever change the way we communicate with one another. It was a pivotal moment in history that opened up new possibilities for human connection and interaction. The first public demonstration of the telephone marked not only a milestone in technological advancements but also a turning point in our society, paving the way for the digital age that we know today.",
  "word count": 216,
  "dialog": [
    {
      "Billy": "I loved how the novel highlighted the importance of perseverance and teamwork. Bell's determination to invent the telephone was truly inspiring."
    },
    {
      "Kerry": "Yeah, but what I found most fascinating was how the invention changed society. The way people connected with each other instantly was mind-blowing!"
    },
    {
      "Meg": "I know, right? It's amazing to think about how something as simple as a phone call could bring people together like that. And it made me realize how much we take technology for granted nowadays."
    },
    {
      "Lui": "As an educator, I appreciated the novel's emphasis on the importance of learning from failures and continuing to push boundaries. Bell's story serves as a great reminder that even the most complex problems can be solved with hard work and creativity."
    },
    {
      "Billy": "Exactly! And it's not just about the technology itself, but how it brings people together. I loved reading about the first phone call between Bell and his team member."
    },
    {
      "Kerry": "Ha! Yeah, that part was hilarious! 'Mr. Watson, come here, I want to see you'... classic!"
    },
    {
      "Meg": "And the way they had to troubleshoot all those technical issues was so cool. It's amazing what people can accomplish when they work together towards a common goal."
    },
    {
      "Lui": "Well said, Meg. The novel does an excellent job of showcasing the power of collaboration and innovation. As educators, we should strive to inspire our students with stories like Bell's."
    }
  ],
  "quiz": [
    {
      "question": "What was Alexander Graham Bell's vision for a device that could instantly connect people?",
      "options": [
    ...
    {
      "question": "What was one of Bell's team members' reactions to the first phone call?",
      "options": [
