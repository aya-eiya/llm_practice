...
const data: QuizData = {
  "event": {
    "event": "First public screening of 'The Jazz Singer'",
    "details":
      "On May 21st, 1927, the first public screening of 'The Jazz Singer' took place in New York City's Warner Bros. Theater.",
  },
  "date": "2024-05-21",
  ...
  "quiz": [
    {
      ...
      "options": [
        ...
        "To make a groundbreaking movie",
    ...
    {
      "question": "Who said 'It's like something out of a sci-fi movie!'?",
      "options": [
        "Billy",
        "Kerry",
        "Meg",
    ...
    {
      "question": "What was praised by Lui in the dialogue?",
      "options": [
        "The plot and character development",
        "The film's innovative use of technology",
        "The way the characters' emotions shone through on screen",
        "The music in the background",
        "The lighting in the theater",
      ],
      "answer": 2,
    },
    {
      "question": "What did Kerry hope filmmakers wouldn't forget?",
      "options": [
        "The importance of storytelling",
        "The new technology",
        "The old movies",
        "The film's innovative use of sound",
        "The way characters moved on screen",
      ],
      "answer": 2,
    },
  ],
  ...
  "descriptions": {
    "grammar": {
      "patterns": [
        {
          "pattern": "S + V",
          "explanation": "A simple sentence with a subject and a verb.",
          "usage": [
      ...
      "vocabularies": [
        {
          "class": "Noun",
          "word": "Hollywood",
          "meaning": "a city in California known for its film industry",
          "usage": [
        ...
        },
        {
          "class": "Verb",
          "word": "dreamed",
          "meaning": "to have a strong desire or aspiration",
          "usage": [
            "Among them was a young director named Jack, who had always dreamed of making...",
          ],
          "pronounce": "/driːmd/",
          "example": "I've always dreamed of traveling the world.",
        },
        {
          "class": "Adjective",
          "word": "revolutionary",
          "meaning": "new and exciting, often changing or improving something",
          "usage": [
            "It was said that this was no ordinary film, but something revolutionary...",
          ],
          "pronounce": "/rɪvəlˈʃənəri/",
          "example": "The new smartphone is a revolutionary technology.",
        },
        {
          "class": "Noun",
          "word": "theater",
          "meaning": "a place where plays, films, or concerts are performed",
          "usage": [
            "He received an invitation to attend a private screening at Warner Bros. Theater.",
          ],
          "pronounce": "/ˈθiːɪtər/",
          "example": "The Broadway theater was packed with fans.",
        },
        {
          "class": "Adverb",
          "word": "ordinarily",
          "meaning": "in a usual or normal way",
          "usage": [
            "It was said that this was no ordinary film, but something revolutionary...",
          ],
          "pronounce": "/ˌɔrdɪnˈærli/",
          "example": "The team plays soccer ordinarily on weekends.",
        },
        {
          "class": "Verb",
          "word": "came",
          "meaning": "to arrive or appear in a place or situation",
          "usage": [
        ...
        },
        {
          ...
          "pronounce": "/ˈɡraʊndˌbeɪtɪŋ/",
          "example": "The new medical breakthrough is groundbreaking.",
        },
        {
          "class": "Noun",
          "word": "masterpiece",
          "meaning": "a work of art that is considered to be very good",
          "usage": [
            "It was like nothing he had ever seen before – a true masterpiece...",
          ],
          "pronounce": "/ˈmɑːstəˌpɪs/",
          "example":
