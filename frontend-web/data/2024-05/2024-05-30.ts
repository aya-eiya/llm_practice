...
const data: QuizData = {
  ...
  "body":
    "In the heart of Chicago's bustling streets, detective Emily Carter found herself amidst a puzzling case. A small firecracker, seemingly harmless, had sparked a fatal explosion at a labor protest.\n\n Amidst the chaos and smoke, one officer lay dead, and several others were critically injured. As Emily dug deeper, she uncovered a web of tensions between workers and factory owners.\n\n Each suspect had their own motive, their own secrets. The factory owner, desperate to quell unrest, the union leader, seeking revenge, the rogue worker with a grudge. With each interview, Emily sifted through a barrage of lies and half-truths.\n\n The key, she realized, lay in the details - a torn piece of clothing, a whispered conversation caught in the wind. Using her keen eye for observation and her knowledge of human nature, Emily unraveled the mystery, exposing the true culprit and their twisted plan.\n\n Justice was served, but the echoes of that fateful day lingered, a reminder of the dangerous divide between those who toiled and those who profited.",
  "word count": 169,
  "dialog": [
    {
