...
const data: QuizData = {
  "event": {
    ...
    "details": "On May 18th, 1839, Louis Daguerre held the first public photography exhibition at the French Academy of Sciences, showcasing his daguerreotypes to the scientific community and marking a significant milestone in the development of photography as an art form."
  },
  "date": "2024-05-18",
  "title": "A New Lens on Art",
  "body": "In May of 1839, Louis Daguerre stood before a crowd of eager spectators at the French Academy of Sciences, his heart pounding with anticipation. For months, he had worked tirelessly to perfect his daguerreotype process, and now it was time to share his discoveries with the world.  As he stepped forward to address the audience, Daguerre knew that this moment would change everything. His invention, a revolutionary way of capturing images on metal plates, promised to bring a new level of realism to art and revolutionize the way people viewed the world around them.  The crowd, a mix of artists, scientists, and curious onlookers, leaned in eagerly as Daguerre began his demonstration. With each passing moment, their excitement grew, and soon they were all engrossed in the spectacle before them.  As the images emerged from the metal plates with stunning clarity, the crowd was left breathless. They had never seen anything like it - a window into the world that was both familiar and yet entirely new.  And so, on that fateful May day in 1839, photography was born. The art form would go on to captivate the imaginations of people around the world, forever changing the way we see and document our lives.",
  "word count": 204,
  "dialog": [
    {
      "Billy": "I loved how the novel described Daguerre's process of perfecting his daguerreotype. It was so detailed and made me feel like I was right there with him."
    },
    {
      "Kerry": "Yeah, I know what you mean Billy! And I liked how it showed how photography could change the way people saw the world. It's crazy to think about how much has changed since then."
    },
    {
      "Meg": "I know I'm a bookworm and all, but I have to say, this novel really brought history to life for me. The descriptions of Paris in the 19th century were so vivid!"
    },
    {
      "Lui": "As a teacher, I appreciate how the novel highlighted the significance of Daguerre's invention. It's amazing to think about how it has impacted our daily lives."
    },
    {
      "Billy": "Exactly Lui! And I think what I liked most was how it showed the power of human curiosity and perseverance. Daguerre didn't give up, even when faced with challenges"
    },
    {
      "Kerry": "That's so true Billy! And I loved how the novel wove together science, art, and history to tell its story."
    },
    {
      "Meg": "I think what struck me most was the way the novel captured the excitement and uncertainty of the time. It felt like anything could happen!"
    }
  ],
  "quiz": [
    {
