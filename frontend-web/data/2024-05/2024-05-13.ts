...
const data: QuizData = {
  "event": {
    ...
    "details": "The Solomon R. Guggenheim Museum opened to the public on May 21, 1959, but the groundbreaking ceremony was held on May 13th, 1959."
  },
  "date": "2024-05-13",
  "title": "The Guggenheim Effect",
  "body": "In a world where technology had advanced to the point of bending reality itself, the opening of the Guggenheim Museum in New York City marked a turning point for humanity. On May 21st, 2059, the museum opened its doors to the public, revealing a hidden layer of existence that no one could have imagined.  As people walked through the futuristic halls of the museum, they were suddenly struck by an unexplainable phenomenon. The world around them began to shift and change, as if time itself had been rewritten. Buildings disappeared and reappeared in different locations, while trees sprouted from the concrete, creating a jungle-like environment.  Scientists rushed to the scene, trying to understand what was happening. They discovered that the Guggenheim Museum was not just a place for art, but a gateway to a parallel universe. The opening of the museum had created a ripple effect, allowing the two universes to collide and merge in an unpredictable way.  From that day on, the world was never the same again. The Guggenheim Effect had changed everything, ushering in a new era of discovery and understanding.",
  "word count": 184,
  "dialog": [
    {
      "Billy": "I'm still trying to wrap my head around this parallel universe concept. How did the Guggenheim Museum even do that?"
    },
    {
      "Kerry": "Yeah, me too! It's like our whole reality was turned upside down. I mean, what about all the things we thought were true before?"
    },
    {
      "Meg": "I know, right? It's like we're living in a dream or something. But think of all the possibilities now..."
    },
    {
      "Lui": "As educators, it's our responsibility to guide our students through this new reality and help them make sense of it."
    },
    {
      "Kerry": "Exactly! We need to be there for Billy here, who's probably feeling a bit overwhelmed by all this."
    },
    {
      "Meg": "I'm more excited than anything. I mean, what if we can actually travel between universes? Can you imagine?"
    },
    {
      "Billy": "I don't know... it feels like everything we thought was certain is no longer true. How do we even begin to make sense of this?"
    },
    {
      "Lui": "Well, Billy, that's exactly why we need to work together and use our collective knowledge to try and understand what's happening."
    },
    {
      "Kerry": "Yeah, and maybe we can even find a way to communicate with people in the other universe... who knows?"
    }
  ],
  "quiz": [
    {
      "question": "What was the significant event that marked a turning point for humanity?",
      "options": [
    ...
    {
      "question": "What was the unexpected phenomenon that occurred when people walked through the Guggenheim Museum?",
      "options": [
    ...
    {
      "question": "What did the scientists discover was happening after the opening of the Guggenheim Museum?",
      "options": [
    ...
    {
      "question": "Who expressed excitement about the possibility of traveling between universes?",
      "options": [
        "Billy",
        "Kerry",
        "Meg",
