...
const data: QuizData = {
  "event": {
    ...
    "details": "Three-day music festival held on a dairy farm in Bethel, New York from August 15 to 17, 1969, featuring iconic performances by Jimi Hendrix, The Who, Joan Baez, Crosby, Stills & Nash, Santana, and many others."
  },
  "date": "2024-05-09",
  "title": "A Summer of Love",
  "body": "In the summer of 1969, amidst a backdrop of political and social turmoil, a group of young idealists gathered on a dairy farm in Bethel, New York to celebrate love, peace, and unity. The event, known as the Woodstock Music Festival, was three days of music and camaraderie that brought together some of the most iconic performers of the time - Jimi Hendrix, The Who, Joan Baez, Crosby, Stills & Nash, Santana, and many others.At the heart of this musical utopia was a young couple, Sarah and Jack. They had met at the festival, bonding over their shared love of music and their desire to make a difference in the world. As they danced and sang along to the performances, they fell deeper in love with each other and with the spirit of Woodstock.Over the course of the weekend, Sarah and Jack experienced all that Woodstock had to offer - from the muddy fields and the late-night bonfires, to the mind-blowing performances that left them speechless. As they held hands and watched the sun rise on the final day of the festival, they knew that their love was something special - a love that could weather any storm, and a love that would last a lifetime.",
  "word count": 206,
  "dialog": [
    {
      "Billy": "I loved how Sarah and Jack's love story was woven throughout the festival. It felt so real."
    },
    {
      "Kerry": "Yeah, I was skeptical at first, but their romance really added to the magic of Woodstock for me."
    },
    {
      "Meg": "I think what struck me most was how the novel captured the essence of a generation's spirit. The music and the vibes just came alive on those pages."
    },
    {
      "Lui": "As an educator, I appreciated how the novel approached historical events like Woodstock in a way that was both informative and engaging for young readers."
    },
    {
      "Kerry": "And can we talk about the music? I mean, some of those performances were iconic! Jimi Hendrix, The Who..."
    },
    {
      "Billy": "Absolutely! The music was such an integral part of the festival's atmosphere. It really brought the characters to life."
    },
    {
      "Meg": "I loved how the novel wove together the music, the romance, and the politics of the time. It felt like a true reflection of that era."
    },
    {
      "Lui": "Well said, Meg. And I think it's great that the novel can serve as a window into the past for young readers today."
    },
    {
      "Kerry": "Definitely. It made me want to learn more about Woodstock and its significance in American history."
    },
    {
      "Billy": "Yeah, me too. The novel has definitely piqued my interest in learning more about that time period."
    }
  ],
  "quiz": [
    {
  ...
  "descriptions": {
    "grammar": {
      "patterns": [
        {
          "pattern": "S + V",
          "explanation": "The basic sentence structure, where S is the subject and V is the verb.",
          "usage": [
        ...
        {
          "pattern": "S + V + C",
          "explanation": "The sentence structure with a complement, where S is the subject, V is the verb, and C is the complement.",
          "usage": [
        ...
        {
          "pattern": "S + V + O",
          "explanation": "The sentence structure with an object, where S is the subject, V is the verb, and O is the object.",
          "usage": [
        ...
        {
          "pattern": "S + V + O + O",
          "explanation": "The sentence structure with two objects, where S is the subject, V is the verb, and O1 and O2 are the first and second objects.",
          "usage": [
        ...
        {
          "pattern": "S + V + O + C",
          "explanation": "The sentence structure with an object and a complement, where S is the subject, V is the verb, O is the object, and C is the complement.",
          "usage": [
      ...
      "vocabularies": [
        ...
        },
        {
          "class": "Noun",
          "word": "festival",
          "meaning": "a special event or celebration, especially one that involves music, dance, or other forms of entertainment",
          "usage": [
        ...
        },
        {
          "class": "Noun",
          "word": "idealists",
          "meaning": "people who have high ideals or principles, and are often motivated by a desire to make a positive difference in the world",
          "usage": [
            "a group of young idealists gathered...",
            "The idealist believes that..."
          ],
          "pronounce": "/ˌaɪdiˈlɪstz/",
          "example": "She's an idealist who wants to change the world through her art."
        },
        {
          "class": "Verb",
          "word": "celebrate",
          "meaning": "to mark or honor a special event or occasion, often with festivities or ceremonies",
          "usage": [
        ...
        },
        {
          "class": "Adjective",
          "word": "iconic",
          "meaning": "widely recognized and admired, often because of their influence or impact on society",
          "usage": [
            "some of the most iconic performers..."
          ],
          "pronounce": "/aɪˈkɒnɪk/",
          "example": "The iconic skyscraper in New York City is a symbol of progress."
        },
        {
          "class": "Pronoun",
          "word": "they",
          "meaning": "used to refer to people or animals previously mentioned, or to people or animals that are plural",
          "usage": [
        ...
        },
        {
          "class": "Noun",
          "word": "weekend",
          "meaning": "a period of two days, including Saturday and Sunday, which is often considered a time for leisure or relaxation",
          "usage": [
        ...
        },
        {
          "class": "Adverb",
          "word": "special",
          "meaning": "unique or unusual, often in a way that is pleasing or appealing",
          "usage": [
